...
class Screen_Window_1:
    def __init__(self, master):
        ...
        self.Lbl_Title_Login = Label(self.Frame, text ='Login Menu', font = ('arial', 55, 'bold'), bg ='gray', fg ='Black')
        self.Lbl_Title_Login.grid(row = 0, column = 0, columnspan =3, pady = 40)
        
        self.Log_Frame_1 = LabelFrame(self.Frame, width = 1350, height = 600, relief ='ridge', bg ='gray', bd = 15,
                                      font = ('arial',20,'bold'))
        self.Log_Frame_1.grid(row = 1, column =0)
        self.Log_Frame_2 = LabelFrame(self.Frame, width = 1000, height = 600, relief ='ridge', bg ='gray', bd = 15,
                                      font = ('arial',20,'bold'))
        self.Log_Frame_2.grid(row = 2, column = 0)


        #===================================================LABEL and ENTRIES=======================================================================
        self.lbl_uname = Label(self.Log_Frame_1, text ='Username', font = ('arial', 20, 'bold'), bg ='gray', bd = 20)
        ...
        self.lbl_pass = Label(self.Log_Frame_1, text ='Password', font = ('arial', 20, 'bold'), bg ='gray', bd = 20)
